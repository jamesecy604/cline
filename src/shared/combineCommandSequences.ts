import { mayaiMessage } from "./ExtensionMessage"

/**
 * Combines sequences of command and command_output messages in an array of mayaiMessages.
 *
 * This function processes an array of mayaiMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of mayaiMessage objects to process.
 * @returns A new array of mayaiMessage objects with command sequences combined.
 *
 * @example
 ...
 */
export function combineCommandSequences(messages: mayaiMessage[]): mayaiMessage[] {
	const combinedCommands: mayaiMessage[] = []
