...
/**
 * Combines API request start and finish messages in an array of mayaiMessages.
 *
 ...
 * @returns A new array of mayaiMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: mayaiMessage[]): mayaiMessage[] {
	const combinedApiRequests: mayaiMessage[] = []
