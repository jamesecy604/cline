...
import { mayaiCheckpointRestore } from "../../../../src/shared/WebviewMessage"
...
export const CheckpointOverlay = ({ messageTs }: CheckpointOverlayProps) => {
	...
	const handleRestoreTask = () => {
		...
		vscode.postMessage({
			...
			number: messageTs,
			text: "task" satisfies mayaiCheckpointRestore,
		})
	}
	...
	const handleRestoreWorkspace = () => {
		...
		vscode.postMessage({
			type: "checkpointRestore",
			number: messageTs,
			text: "workspace" satisfies mayaiCheckpointRestore,
		})
	}
	...
	const handleRestoreBoth = () => {
		...
		vscode.postMessage({
			type: "checkpointRestore",
			number: messageTs,
			text: "taskAndWorkspace" satisfies mayaiCheckpointRestore,
		})
	}
